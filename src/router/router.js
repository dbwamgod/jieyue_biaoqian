...
//标签管理
{
    ...
    children: [
    {path: 'index', title: '标签详情', name: 'Tab_management_list', component: () => import('@/views/tabManagement/tab_management.vue')},{path: 'newCreate', title: '新建', name: 'new_create', component: () => import('@/views/my-components/editTable/modal_table.vue')},
]
},
//international
{
